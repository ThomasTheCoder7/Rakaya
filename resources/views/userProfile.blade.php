...
<div class="flex items-center justify-content-center h-full flex-col">
    ...
    <form action="{{route('save')}}" class="" id='userProfileForm' method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group py-3">
            ...
            <input type="text" name="phone" id="phone" maxlength="9" minlength="9" disabled
                class="rounded-md border-0 py-1.5 pl-3 pr-3 text-gray ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-1 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
        ...
        <div class="form-group py-3 flex items-center">
            ...
            <div
                class="disabled parent cursor-pointer focus-within:border-wine flex items-center border-3 cursor-pointer transition duration-300 bg-white  border-2 border-gray-200 rounded w-full py-1 px-2 text-gray-700 focus:outline-none focus:bg-gray-200 mt-2 font-bold text-lg justify-center mb-6">
                <select name="user_type" disabled id="user_type"
                    class=" w-full focus:outline-none overflow-hidden cursor-pointer" dir='rtl' onfocus='this.size=4;'
        ...
        <button type="submit" id="save" disabled
            class="disabled inline-flex items-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300">
