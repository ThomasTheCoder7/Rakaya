...
<div class="flex items-center justify-content-center h-screen flex-col">
    ...
    <form action="{{route('save')}}" class="" id='userProfileForm' method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group pb-3">
            ...
            <img src="storage/avatars/{{$user->id}}.png" width="300">
        ...
        <button type="submit" id="save" disabled class="inline-flex items-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300">
