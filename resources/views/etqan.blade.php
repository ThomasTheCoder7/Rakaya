...
<div class="bg-lightgray pb-6 sm:pb-8 lg:pb-12 h-screen" id="home"
...
background: linear-gradient(50deg, rgba(62,62,63,1) 0%, rgba(94,94,95,1) 39%, rgba(106,106,107,1) 53%, rgba(148,148,148,1) 75%, rgba(181,181,181,1) 85%, rgba(220,220,220,1) 92%, rgba(242,241,241,1) 100%);">
    ...
    <section id="home" class="w-full max-w-screen-2xl px-4 md:px-8">
        <div class="flex flex-wrap justify-between pr-10">
            <div class="flex w-full flex-col justify-center text-right h-screen lg:w-2/3">
                ...
                <h2 class="text-3xl font-bold text-lightgray sm:text-4xl md:text-5xl py-2">لخدمات وحلول تقنية
                    المعلومات
                </h2>
...
<div class=" py-6 sm:py-8 lg:py-12 pt-8" id="about">
    <div class="mx-auto max-w-screen-xl px-4 md:px-8">
        <div class="grid gap-8 md:grid-cols-2 lg:gap-12">
            ...
            <div class="md:pt-8">
                ...
                <p class="mb-6 text-darkgray sm:text-lg md:mb-8 text-justify">من واقع خبرتنا في سوق العمل السعودي
                    نقدم
...
<div class="bg-white py-6 sm:py-8 lg:py-12">
    <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
        ...
        <div class="mb-10 md:mb-16">
            <h2 class="mb-4 text-center text-2xl font-bold text-wine md:mb-6 lg:text-3xl">نعمل في إتقان الرقمية على
            </h2>

            <p class="mx-auto max-w-screen-md text-center text-gray md:text-lg">تقديم الحلول التقنية والأمنية التي
                تلبي
        ...
        <div class="grid gap-12 sm:grid-cols-2 xl:grid-cols-3 xl:gap-16">
            ...
            <div class="flex flex-col items-center">
                ...
                <p class="mb-2 text-center text-gray">أن نكون سند وحماية تساهم في نمو ونجاح المؤسسات والشركات من
                    خلال
